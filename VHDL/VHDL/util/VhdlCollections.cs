            ...
            where E : class
        {
            foreach (E element in list)
            {
                if (element is T)
                {
                    ...
                    if (identifier.EqualsIgnoreCase(tmp.Identifier))
                    {
                        return tmp;
                    }
                }
            ...
            public object Resolve(string identifier)
            {
                foreach (E declaration in this)
                {
                    if (declaration is EnumerationType)
                    {
                        ...
                        if (identifier.EqualsIgnoreCase(type.Identifier))
                        {
                            return type;
                        }
                    ...
                    else if (declaration is PhysicalType)
                    {
                        ...
                        if (identifier.EqualsIgnoreCase(type.PrimaryUnit))
                        {
                        ...
                        {
                            if (identifier.EqualsIgnoreCase(unit.Identifier))
                            {
                    ...
                    else if (declaration is NamedEntity)
                    {
                        ...
                        if (identifier.EqualsIgnoreCase(identElement.Identifier))
                        {
                            return declaration;
                        }
                    }
                    else if (declaration is SignalDeclaration)
                    {
                        ...
                        {
                            if (o.Identifier.EqualsIgnoreCase(identifier))
                            {
                                return o;
                            }
                        }
                    ...
                    else if (declaration is Alias)
                    {
                        ...
                        if (objDecl.Designator.EqualsIgnoreCase(identifier))
                        {
                    ...
                    else if (declaration is Subtype)
                    {
                        ...
                        if (objDecl.Identifier.EqualsIgnoreCase(identifier))
                        {
                            return objDecl;
                        }
                    }
            ...
            public object Resolve(string identifier)
            {
                foreach (E element in this)
                {
                    if (element is NamedEntity)
                    {
                        ...
                        if (namedEntity.Identifier.EqualsIgnoreCase(identifier))
                        {
                            return element;
                        }
                    }
