...
namespace VHDLCompiler.VHDLObserver
{
    public class ArchitectureObserver : VHDLObserverBase
    {
        ...
        private VHDLParser.Logger logger;
        public VHDLParser.Logger Logger
        {
            get { return logger; }
            set { logger = value; }
        }
        ...
        public ArchitectureObserver(VHDL.libraryunit.Architecture architecture, VHDLParser.Logger logger)
        {
            this.logger = logger;
